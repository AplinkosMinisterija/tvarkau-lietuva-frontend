...
class AdminApi {
  ...
  Future<Response<BuiltList<FullDumpDto>>> adminControllerGetAllDumps({
    ...
    BuiltList<FullDumpDto>? _responseData;
    ...
    return Response<BuiltList<FullDumpDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<FullReportDto>>> adminControllerGetAllReports({
    ...
    BuiltList<FullReportDto>? _responseData;
    ...
    return Response<BuiltList<FullReportDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TransferReportDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TransferReportDto>> adminControllerTransferReport({
    required TransferReportDto transferReportDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/admin/reports/transfer';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TransferReportDto);
      _bodyData =
          _serializers.serialize(transferReportDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    TransferReportDto? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(TransferReportDto),
            ) as TransferReportDto;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<TransferReportDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<FullReportDto>> adminControllerUpdateReport({
    ...
    required BuiltList<String> officerImageUrls,
    required BuiltList<String> imageUrls,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        r'isVisible':
            encodeFormParameter(_serializers, isVisible, const FullType(bool)),
        r'isDeleted':
            encodeFormParameter(_serializers, isDeleted, const FullType(bool)),
        r'comment':
            encodeFormParameter(_serializers, comment, const FullType(String)),
        r'status':
            encodeFormParameter(_serializers, status, const FullType(String)),
        r'officerImageUrls': encodeFormParameter(_serializers, officerImageUrls,
            const FullType(BuiltList, [FullType(String)])),
        r'imageUrls': encodeFormParameter(_serializers, imageUrls,
            const FullType(BuiltList, [FullType(String)])),
