...
class ReportsApi {
  ...
  Future<Response<PublicReportDto>> reportControllerCreateNewReport({
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        if (phoneNumber != null)
          r'phoneNumber': encodeFormParameter(
              _serializers, phoneNumber, const FullType(String)),
      });
    ...
    return Response<PublicReportDto>(
      data: _responseData,
  ...
  Future<Response<BuiltList<PublicReportDto>>>
    ...
    BuiltList<PublicReportDto>? _responseData;
    ...
    return Response<BuiltList<PublicReportDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> reportControllerGetGeojson({
    required JsonCoordsDto jsonCoordsDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(JsonCoordsDto);
      _bodyData = _serializers.serialize(jsonCoordsDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  Future<Response<ReportStatisticsDto>> reportControllerGetReportStatistics({
    ...
    final _path = r'/reports/statistics';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ReportStatisticsDto? _responseData;
    ...
    return Response<ReportStatisticsDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<String>> reportControllerSendFeedbackReport({
    ...
    final _path = r'/reports/feedback-report';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
