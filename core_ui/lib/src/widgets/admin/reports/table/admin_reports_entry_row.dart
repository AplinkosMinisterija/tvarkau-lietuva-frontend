...
class AdminReportsEntryRow extends StatefulWidget {
  const AdminReportsEntryRow({
    super.key,
    required this.width,
  ...
  @override
  State<AdminReportsEntryRow> createState() => _AdminReportsEntryRowState();
}

class _AdminReportsEntryRowState extends State<AdminReportsEntryRow> {
